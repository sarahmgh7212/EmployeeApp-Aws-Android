...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    private List<ListEmployeesQuery.Item> mData = new ArrayList<>();;
    ...
    public void setItems(List<ListEmployeesQuery.Item> items) {
        mData = items;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(ListEmployeesQuery.Item item) {
